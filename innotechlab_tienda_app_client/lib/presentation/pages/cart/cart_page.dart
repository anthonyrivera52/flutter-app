...
import 'package:mi_tienda/presentation/widgets/cart_item_card.dart';
...
class CartPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    double totalAmount = cartState.cartItems.fold(0.0, (sum, item) => sum + (item.product.price * item.quantity));
