...
class CustomTextField extends StatelessWidget {
  ...
  final Widget? suffixIcon; // Para iconos como el ojo en contraseñas
  final bool readOnly; // Para campos de solo lectura
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: Theme.of(context).colorScheme.surface, // Usa el color de superficie del tema
