...
class AuthViewModel extends StateNotifier<AuthStateModel> {
  ...
  Future<bool> signUp() async {
    ...
    try {
      ...
      final displayName = SecurityService.sanitizeInput(
      ...
      final response = await Supabase.instance.client.auth.signUp(
        ...
        emailRedirectTo:
            null, // No redirigir a URL, usaremos verificación manual
      );
      ...
      if (response.user != null) {
        ...
        state = state.copyWith(
          ...
          errorMessage: null,
          isAuthenticated:
              response.session != null, // True si se autenticó directamente
          loggedInEmail: email,
        );
